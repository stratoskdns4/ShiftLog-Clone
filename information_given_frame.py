...
class InformationGivenFrame(tk.Frame):
    ...
    def __init__(self, root, **options):
        ...
        self.title_label = tk.Label(self, text="INFORMATION GIVEN", font=LABEL_FONT, justify=tk.LEFT)
    ...
    def on_submit(self):
        information_given_data = {
            ...
            "time":self.information_given_time_entry.get(),
...
# Use this to test your frame as a single app
        if __name__ == "__main__":
            ...
            single_frame_runner(InformationGivenFrame)
